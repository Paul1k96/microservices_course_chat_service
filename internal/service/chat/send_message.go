...
import (
	...
	"github.com/Paul1k96/microservices_course_chat_service/internal/repository/message/mapper"
...
func (s *service) SendMessage(ctx context.Context, message *model.Message) error {
	...
	return s.messageRepo.Create(ctx, mapper.ToRepoCreateFromMessage(message))
}
